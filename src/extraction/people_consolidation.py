    ...
    for dup_group in duplicates:
        ...
        for idx in indices:
            ...
            if bio:
                ...
                # Fill missing biographical fields
                base_bio = base_person.get("biographical_profile", {})
                for field in [
                    "birth_date",
                    "birth_place",
                    "death_date",
                    ...
                    if bio.get(field) and not base_bio.get(field):
                        base_bio[field] = bio[field]
        ...
        merged_people.append(base_person)
